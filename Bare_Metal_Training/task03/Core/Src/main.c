...
int main(void)
{
  ...
  value_Hertz_t actual = 20;
  value_Hertz_t value_after_PSC = 10000;

  timer_pwm_init(&active_timer, actual, value_after_PSC);
  timer_pwm_change_ARR(&active_timer, &TIM4->ARR);
